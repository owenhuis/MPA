...
class GameSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('games')->insert([
            ...
            ['name' => 'rock paper scissors', 'slug' => 'rock-paper-scissors', 'route' => 'rps', 'description' => 'Het klassieke steen-papier-schaar spel', 'created_at' => now(), 'updated_at' => now(), 'working' => FALSE],
        ]);
    }
}
